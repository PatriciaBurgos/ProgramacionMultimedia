...
import com.example.moviespatri.details_series.com.example.moviespatri.Genre;
import com.example.moviespatri.ui.peliculas.DetallesAdapter_Generos;

import java.util.ArrayList;
import java.util.List;

public class DetallesAdapter_Generos_Series extends RecyclerView.Adapter<DetallesAdapter_Generos_Series.moviesViewHolder> {
        /*
        Atributos
        */
        ...
        Constructor
        */
        public DetallesAdapter_Generos_Series(Context context) {
