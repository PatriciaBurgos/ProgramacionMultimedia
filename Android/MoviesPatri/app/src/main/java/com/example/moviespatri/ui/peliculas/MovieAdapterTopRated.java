 ...
 */
public class MovieAdapterTopRated extends RecyclerView.Adapter<MovieAdapterTopRated.moviesViewHolder> {
    /*
    Atributos
    */
    ...
    private MovieAdapterTopRated.OnItemClickListener listener; //Listener para cuando se haga click
    ...
    Constructor
    */
    public MovieAdapterTopRated(Context context) {
    ...
    */
    private void setListener () {
        this.listener = new MovieAdapterTopRated.OnItemClickListener() {
            @Override
