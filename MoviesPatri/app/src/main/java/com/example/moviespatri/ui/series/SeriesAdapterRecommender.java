...
import com.example.moviespatri.series_popular.com.example.moviespatri.Result;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;
import java.util.List;

public class SeriesAdapterRecommender extends RecyclerView.Adapter<SeriesAdapterRecommender.moviesViewHolder> {
        /*
        Atributos
        */
        public final Context context; //Almacena el contexto donde se ejecutará
        private ArrayList<com.example.moviespatri.series_popular.com.example.moviespatri.Result> list; //Almacenará las películas a mostrar
        ...
        Constructor
        */
        public SeriesAdapterRecommender(Context context) {
